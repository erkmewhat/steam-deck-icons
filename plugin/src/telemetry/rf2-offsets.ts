 ...
 */
export function telemetryOffset(vehicleIndex: number, fieldOffset: number): number {
 ...
 */
export function scoringInfoOffset(fieldOffset: number): number {
 ...
 */
export function vehicleScoringOffset(vehicleIndex: number, fieldOffset: number): number {
 ...
 */
export function wheelOffset(vehicleIndex: number, wheelIndex: number, fieldOffset: number): number {
